...
mongoose.connect(config.dbURI, (err, db) => {
  db.dropDatabase()
    .then(()=> Place.create({
      ...
      name: 'Niagra Falls',
      country: 'Canada/USA',
      image: '/assets/niagara-falls.jpg',
      ...
      country: 'England',
      image: '/assets/buckingham-palace.jpg',
      ...
      country: 'Chile',
      image: '/assets/thermas-geometrica.jpg',
      ...
      name: 'Geirangerfjord',
      country: 'Norway',
      image: '/assets/geirangerfjord.jpeg',
      ...
      country: 'Rwanda',
      image: '/assets/volcanoes-national-park.jpg',
      ...
      country: 'China',
      image: '/assets/great-wall-china.jpg',
